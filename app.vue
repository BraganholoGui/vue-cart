<template>
  <div>
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: #52dea6; padding: 0 !important;">
      <div class="" style="background-color: #52dea6; width: 100%;">
        ...
        <div class="" id="">
          <ul class="navbar-nav">
            ...
            <li v-if="isAuthenticated" class="nav-item">
              <router-link class="nav-link" to="/panel">Painel</router-link>
            </li>
            <li v-if="isAuthenticated" class="nav-item">
...
export default {
  ...
  methods: {
    ...mapActions(['clearAuthToken']), // Ação para limpar o token no Vuex
    logout() {
      this.clearAuthToken(); // Limpa o token do Vuex
